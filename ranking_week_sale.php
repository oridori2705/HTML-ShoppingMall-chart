...
<html>
    ...
    $sql = "SELECT orders.prodid, product.prodname, product.image, product.price, SUM(orders.count)
            ...
            WHERE product.prodid = orders.prodid 
				AND orders.orderDT >= DATE_ADD(CURDATE(), INTERVAL -7 DAY) AND orders.orderDT <= CURDATE()
            GROUP BY prodid 
	...
	<body>
		...
		<div class="div">
			...
			<p class="p_main">
                ...
                <a href="ranking_week_sale.php"><font class="font_sel" style="color:black; font-weight: bold;">주간</font></a>
                <a href="ranking_month_sale.php"><font>월간</font></a>
			</p>
			<p class="p_main">
				<font class = "font_clf">분류</font>
				<a href="ranking_week_order.php"><font>주문 많은수</font></a>   
                <a href="ranking_week_sale.php"><font class="font_sel" style="color:black; font-weight: bold;">판매량</font></a>
