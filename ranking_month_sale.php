...
<html>
    ...
    $sql = "SELECT orders.prodid, product.prodname, product.image, product.price, SUM(orders.count)
            FROM product, orders
            WHERE product.prodid = orders.prodid
            GROUP BY prodid 
            ORDER BY SUM(orders.count) DESC";
    ...
    while($row = mysqli_fetch_array($result)){
        ...
        $sellcount_array[] = ($row["SUM(orders.count)"]);
    }
        ?>
    ...
    <body>
        ...
        <div class="div">
            ...
            <p class="p_main">
                ...
                <a href="ranking_daily_sale.php"><font>일간</font></a>
                <a href="ranking_week_sale.php"><font>주간</font></a>
                <a href="ranking_month_sale.php"><font class="font_sel" style="color:black; font-weight: bold;">월간</font></a>
            </p>
            <p class="p_main">
                <font class = "font_clf">분류</font>
                <a href="ranking_month_order.php"><font>주문 많은수</font></a>   
                <a href="ranking_month_sale.php"><font class="font_sel" style="color:black; font-weight: bold;">판매량</font></a>
                <a href="ranking_month_point.php"><font>평점순</font></a>
            </p>
                ...
                <tr>
                    <td class="td_border">
                        <table class="table_pro">
                            ...
                            <tr><td class="td"><?php echo $sellcount_array[0]."판매" ?></td></tr>
                    ...
                    <td class="td_border">
                        <table class="table_pro">
                            ...
                            <tr><td class="td"><?php echo $sellcount_array[1]."판매" ?></td></tr>
                        ...
                        <table class="table_pro">
                            ...
                            <tr><td class="td"><?php echo $sellcount_array[2]."판매" ?></td></tr>
                        ...
                        <table class="table_pro">
                            ...
                            <tr><td class="td"><?php echo $sellcount_array[3]."판매" ?></td></tr>
                        ...
                        <table class="table_pro">
                            ...
                            <tr><td class="td"><?php echo $sellcount_array[4]."판매" ?></td></tr>
                        ...
                        <table class="table_pro">
                            ...
                            <tr><td class="td"><?php echo $sellcount_array[5]."판매" ?></td></tr>
                ...
                <tr>
                    <td class="td_border">
                        <table class="table_pro">
                            ...
                            <tr><td class="td"><?php echo $sellcount_array[6]."판매" ?></td></tr>
                    ...
                    <td class="td_border">
                        <table class="table_pro">
                            ...
                            <tr><td class="td"><?php echo $sellcount_array[7]."판매" ?></td></tr>
                        ...
                        <table class="table_pro">
                            ...
                            <tr><td class="td"><?php echo $sellcount_array[8]."판매" ?></td></tr>
