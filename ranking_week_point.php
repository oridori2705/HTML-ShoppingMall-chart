	...
	<body>
		...
		<div class="div">
			...
			<p class="p_main">
				...
				<a href="ranking_week_point.php"><font class="font_sel" style="color:black; font-weight: bold;">주간</font></a>
			...
			<p class="p_main">
				...
				<a href="ranking_week_point.php"><font class="font_sel" style="color:black; font-weight: bold;">평점순</font></a>
			</p>
