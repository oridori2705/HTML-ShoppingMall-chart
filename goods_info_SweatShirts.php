	...
	<body>
		...
		<div class="goodsInfoFirst">
			<form action="buyProcess.php" method="POST" id="size"> 
				...
				<div class="infoMenu">
					...
					http://ydoag2003.dothome.co.kr/shop/
		...
		<div class="productInfoMiddle">
			...
			<div class="productExplan">
				<ul>
					<li><img src="http://ydoag2003.dothome.co.kr/shop/Images/greensweatshirts1.PNG" width="600px" height="600px"></li>
					<li><img src="http://ydoag2003.dothome.co.kr/shop/Images/greensweatshirts2.PNG" width="600px" height="600px"></li>
					<li><img src="http://ydoag2003.dothome.co.kr/shop/Images/greensweatshirts3.PNG" width="600px" height="600px"></li>
					<li><img src="http://ydoag2003.dothome.co.kr/shop/Images/greensweatshirts4.PNG" width="600px" height="600px"></li>
					<li><img src="http://ydoag2003.dothome.co.kr/shop/Images/greensweatshirts5.PNG" width="600px" height="600px"></li>
				</ul>
		</div>
		</div>
