	...
	<body>
		...
		<div class="div">
			...
			<p class="p_main">
				...
				<a href="ranking_daily_order.php"><font class="font_sel" style="color:black; font-weight: bold;">일간</font></a>
                <a href="ranking_week_order.php"><font>주간</font></a>
                <a href="ranking_month_order.php"><font>월간</font></a>
			</p>
			<p class="p_main">
				<font class = "font_clf">분류</font>
				<a href="ranking_daily_order.php"><font class="font_sel" style="color:black; font-weight: bold;">주문 많은수</font></a>   
