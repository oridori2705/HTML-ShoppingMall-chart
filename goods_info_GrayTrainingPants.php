	...
	<body>
					...
					<div class="goodsStar">
						...
						<span class="star">★★★★★
								<span style=" width:90px;">
									<?php 
									if($avgstar[0] > 0 && $avgstar[0] <= 1)
                                    {
                                       echo "★";
                                    }
                                    if($avgstar[0] > 1 && $avgstar[0] <= 2)
                                    {
                                        echo "★★";
                                    }
                                    if($avgstar[0] > 2 && $avgstar[0] <= 3)
                                    {
                                        echo "★★★";
                                    }
                                    if($avgstar[0] > 3 && $avgstar[0] <= 4)
                                    {
                                       echo "★★★★";
                                    }
									if($avgstar[0] > 4 && $avgstar[0] <= 5)
                                    {
                                       echo "★★★★★";
                                    }?>
                                    </span>
		...
		<div class="productInfoMiddle">
			...
			<div class="productExplan">
				<ul>
					<li><img src="http://ydoag2003.dothome.co.kr/shop/Images/graypants1.PNG" width="600px" height="600px"></li>
					<li><img src="http://ydoag2003.dothome.co.kr/shop/Images/graypants2.PNG" width="600px" height="600px"></li>
					<li><img src="http://ydoag2003.dothome.co.kr/shop/Images/graypants3.PNG" width="600px" height="600px"></li>
				</ul>
		</div>
		</div>
