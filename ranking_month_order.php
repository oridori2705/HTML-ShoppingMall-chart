...
<html>
    ...
    $sql = "SELECT orders.prodid, product.prodname, product.image, product.price,COUNT(customer.mbti) AS 'SELLCOUNT' 
            FROM product
                INNER JOIN orders 
                    ON product.prodid = orders.prodid AND order.custid
            GROUP BY prodid 
            ORDER BY COUNT(*) DESC";
	...
	<body>
		...
		<div class="div">
			...
			<p class="p_main">
				...
				<a href="ranking_week_order.php"><font>주간</font></a>
				<a href="ranking_month_order.php"><font class="font_sel" style="color:black; font-weight: bold;">월간</font></a>
			</p>
			<p class="p_main">
				<font class = "font_clf">분류</font>
				<a href="ranking_month_order.php"><font class="font_sel" style="color:black; font-weight: bold;">주문 많은수</font></a>	
